...
const programItems = [
  { time: '14:00', icon: '💍', title: 'Торжественная церемония', desc: 'Бракосочетание во Дворце бракосочетания' },
  { time: '15:00', icon: '📸', title: 'Фотосессия', desc: 'Прогулка по парку и памятным местам' },
  { time: '16:30', icon: '🥂', title: 'Банкет', desc: 'Торжественный ужин для гостей' },
  { time: '18:00', icon: '🎂', title: 'Торт', desc: 'Разрезание свадебного торта' },
  { time: '19:00', icon: '💃', title: 'Танцы', desc: 'Первый танец молодожёнов и вечеринка' },
  { time: '23:00', icon: '✨', title: 'Фейерверк', desc: 'Грандиозный финал вечера' },
];


const gifts = [
  { icon: '💵', title: 'Денежный эквивалент', desc: 'Если вы хотите сделать нам приятное — денежный подарок будет очень кстати', account: 'По запросу' },
  ...
  return (
    <div className="min-h-screen bg-wedding-cream relative overflow-x-hidden">
      ...
      <div className="h-96 relative">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2245.372!2d37.6173!3d55.7558!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b54a50b315e573%3A0xa886bf5a3d9b2e68!2z0JzQvtGB0LrQstCw!5e0!3m2!1sru!2sru!4v1700000000000"
          width="100%"
          height="100%"
